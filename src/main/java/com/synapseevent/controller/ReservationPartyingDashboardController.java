...
public class ReservationPartyingDashboardController {
    ...
    private VBox createEventCard(Event event) {
        ...
        // Partying type indicator
        Label typeLabel = new Label("🎉 Party");
        ...
        card.setOnMouseClicked(e -> {
            ...
            Navigator.get().go("/fxml/reservationPartyingDetails.fxml", "Détails Réservation Party");
        });
