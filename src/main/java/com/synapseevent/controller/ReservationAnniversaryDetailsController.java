...
public class ReservationAnniversaryDetailsController {
    ...
    private void loadEventDetails(Long eventId) {
        currentEvent = anniversaryEventDAO.findById(eventId.intValue());
    ...
    private void makeReservation(int seats) {
        ...
        // Make reservation
        boolean success = reservationDAO.reserve(currentEvent.getId().intValue(), userId.intValue(), seats, "ANNIVERSARY");
