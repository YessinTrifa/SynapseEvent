-- Données de test pour Partying et Anniversary Events
-- À exécuter après le schema.sql principal

-- Insertion de venues supplémentaires pour Partying et Anniversary
...
-- Insertion des événements Partying
...
-- Insertion des événements Anniversary
